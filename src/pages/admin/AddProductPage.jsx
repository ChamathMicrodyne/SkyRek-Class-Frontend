      ...
      <div className="w-full h-full max-h-full bg-white rounded-xl p-6 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">Alternative Name</label>
              <input
                type="text"
                value={altName}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              <label className="block mb-1 font-medium text-gray-700">Labelled Price</label>
              <input
                type="number"
                value={labelledPrice}
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">Selling Price</label>
              <input
                type="number"
                value={price}
          ...
          {/* Image Upload */}
          <div>
            <label className="block mb-2 font-medium text-gray-700">Upload Product Images</label>
            <input
              type="file"
              multiple
              accept="image/*"
